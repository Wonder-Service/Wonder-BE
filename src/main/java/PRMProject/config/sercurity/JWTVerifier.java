...
import static PRMProject.config.sercurity.SecurityConstants.AUTHORITIES_KEY;
import static PRMProject.config.sercurity.SecurityConstants.HEADER_STRING;
import static PRMProject.config.sercurity.SecurityConstants.JWT_SECRET;
import static PRMProject.config.sercurity.SecurityConstants.TOKEN_PREFIX;
